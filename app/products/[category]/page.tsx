...
export default function CategoryPage() {
  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-b from-[#F9F7F3] via-white to-white py-16 md:py-42 overflow-hidden">
      ...
      <div className="relative max-w-8xl mx-auto px-6 md:px-12 lg:px-20">
        ...
        >
          ...
          >
            <span className="text-xs text-gray-500 uppercase tracking-widest font-medium">Products</span>
          ...
          <div className="flex items-start justify-between gap-6 mb-6">
            ...
            >
              <Link
                href="/#contact"
                className="inline-flex items-center justify-center gap-2 px-6 py-2.5 bg-transparent border-2 border-[#212C5F] text-[#212C5F] font-semibold text-sm rounded-lg overflow-hidden relative group hover:bg-[#212C5F]/5 transition-all duration-300 hover:scale-105 hover:border-[#4A5B9F] hover:text-[#4A5B9F]"
              >
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            className="text-base md:text-lg text-gray-600 max-w-3xl font-light leading-relaxed"
          >
              ...
              <div className="h-full bg-white/90 backdrop-blur-sm border border-white/60 rounded-2xl overflow-hidden hover:border-[#212C5F]/20 shadow-lg hover:shadow-2xl transition-all duration-500 hover:bg-white">
                ...
                <div className="p-6 md:p-7">
                  ...
                  <motion.h3
                    ...
                    viewport={{ once: true }}
                    className="text-xl font-semibold text-gray-900 mb-3 group-hover:text-[#212C5F] transition-colors duration-300"
                  >
                    {item.name}
                  </motion.h3>
                  ...
                  <motion.p
                    ...
                    viewport={{ once: true }}
                    className="text-gray-600 text-base leading-relaxed font-light"
                  >
                    {item.description}
                  </motion.p>
                </div>
